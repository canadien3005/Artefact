...
public class ModItems {
    ...
    public static List<Item> multiToolItems = new ArrayList<>();

    public static final RegistryObject<Item> MULTI_TOOLS = ITEMS.register("multi_tools", () -> new MultiToolsItem(new Item.Properties().tab(CreativeModeTab.TAB_COMBAT).fireResistant().stacksTo(1)));
